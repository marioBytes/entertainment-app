defmodule Entertainment.Accounts do
  @moduledoc """
  ...
  alias Entertainment.Accounts.User.Query

  def get_user_by_email(email) when is_binary(email) do
    Query.with_bookmarked_videos(email)
    |> Repo.one()
  end
  ...
  def get_user!(id), do: Query.with_bookmarked_videos(id) |> Repo.one()
